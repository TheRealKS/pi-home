...
function loadProgramme(name: string) {
...
function createListEntryDay(dayy: string, events: number): HTMLElement {
...
function createSubHeader(content: string) {
...
function createListEntryContent(type: string, title: string, caption: string) {
...
function timeMath(begin: string, range: number) {
